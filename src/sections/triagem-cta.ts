    ...
    <div class="mx-auto max-w-3xl px-6 py-16 text-center md:py-24 lg:px-8">
      ...
      <div data-reveal style="--reveal-delay: 200ms" class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
        <button
          type="button"
          data-open-triagem
          class="inline-flex items-center justify-center gap-2 rounded bg-bronze-500 px-6 py-3.5 text-sm font-semibold text-graphite-950 transition duration-200 hover:scale-[1.02] hover:bg-bronze-400"
        >
          Iniciar triagem
        </button>
        <a
